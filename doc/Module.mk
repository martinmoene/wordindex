...
DOC    = $(DOC) doc/WordIndex.chm
DOCSRC = $(DOCSRC) $(PRGSRC) $(PRGHDR) $(UNITTST) $(DOCPRG) $(DOCOUT) doc/Doxyfile doc/MainPage.txt doc/Footer.html $(HLP)
